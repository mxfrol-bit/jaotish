...
# Рамка доверия — чтобы звучало как аналитика на данных, а не гороскоп.
CREDIBILITY = (
    "🛰 Это не гороскоп. Разбор построен на точном расчёте параметров момента рождения: "
    "положения светил берутся из астрономических эфемерид космической точности — тех же "
    "моделей, что используют в астрономии и спутниковой навигации, — а алгоритм переводит их "
    "в устойчивые поведенческие паттерны. Это расчёт на данных, а не гадание."
)
CREDIBILITY_SHORT = (
    "🛰 Расчёт на данных, не гадание: точные параметры момента рождения + алгоритм "
